...
const variantClasses: Record<Variant, string> = {
  primary: 'bg-emerald text-paper hover:bg-emerald/90 disabled:bg-emerald/40',
  secondary: 'bg-ink-raised text-paper border border-ink-border hover:border-emerald/50',
