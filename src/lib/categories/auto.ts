...
const CATEGORY_RULES: Array<{
  ...
  {
    kind: 'expense',
    match: ['food', 'dinner', 'lunch', 'breakfast', 'biryani', 'pizza', 'burger', 'cake', 'chai', 'coffee', 'zomato', 'swiggy', 'restaurant', 'cafe', 'snack', 'snacks'],
    category: ['food', 'dining'],
    suggest: 'Food & Dining',
  },
  {
    kind: 'expense',
    match: ['cab', 'uber', 'ola', 'auto', 'rickshaw', 'metro', 'train', 'bus', 'flight', 'petrol', 'diesel', 'fuel', 'parking', 'toll', 'travel'],
    category: ['travel'],
    suggest: 'Travel',
  },
  {
    kind: 'expense',
    match: ['rent', 'electricity', 'wifi', 'internet', 'broadband', 'water', 'utility', 'utilities', 'gas', 'maintenance', 'emi', 'loan', 'credit card'],
    category: ['rent', 'utilities'],
    suggest: 'Rent & Utilities',
  },
  {
    kind: 'expense',
    match: ['netflix', 'movie', 'movies', 'spotify', 'prime', 'hotstar', 'youtube premium', 'game', 'gaming', 'party', 'club', 'entertainment'],
    category: ['entertainment'],
    suggest: 'Entertainment',
  },
  {
    kind: 'expense',
    match: ['medicine', 'doctor', 'hospital', 'health', 'gym', 'pharmacy', 'chemist', 'clinic', 'therapy', 'dentist'],
    category: ['health'],
    suggest: 'Health',
  },
  {
    kind: 'expense',
    match: ['shopping', 'amazon', 'flipkart', 'myntra', 'clothes', 'shoes', 'shirt', 'jeans', 'watch', 'blinkit', 'zepto', 'instamart', 'dmart', 'grocery', 'groceries'],
    category: ['shopping'],
    suggest: 'Shopping',
  },
  {
    kind: 'expense',
    match: ['software', 'tool', 'tools', 'domain', 'hosting', 'subscription', 'app', 'apps', 'saas', 'chatgpt', 'openai', 'claude', 'notion', 'figma', 'canva', 'icloud', 'google one'],
    category: ['software', 'tools'],
    suggest: 'Software & Tools',
  },
  {
    kind: 'expense',
    match: ['meta ads', 'facebook ads', 'instagram ads', 'google ads', 'ad spend', 'ads', 'advertising', 'marketing', 'campaign', 'lead generation'],
  ...
  {
    kind: 'income',
    match: ['salary', 'paycheck', 'income', 'paid me', 'got', 'received', 'dad', 'mom', 'refund', 'cashback'],
    category: ['income', 'other'],
    suggest: 'Other Income',
  },
  {
    kind: 'income',
    match: ['project', 'client', 'freelance', 'work', 'invoice', 'payment'],
