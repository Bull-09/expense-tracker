...
returns table (counterparty_name text, direction text, amount numeric, context text, payee_upi_id text, sharer_name text, created_at timestamptz, expires_at timestamptz)
language sql stable security definer set search_path = public as $$
  ...
  from public.balance_share_links l join public.profiles p on p.id = l.created_by
